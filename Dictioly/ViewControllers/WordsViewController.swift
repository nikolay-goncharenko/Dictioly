...
//		addSubtitleToList.isHidden = true
	...
	@IBAction func addNewItemToList(_ sender: UIButton) {
		let newTitleElement = listItemField.text!
		let newSubtitleElement = subtitleItemField.text!
		addListItem(nameItem: newTitleElement)
		addSubtitleItem(nameItem: newSubtitleElement)
